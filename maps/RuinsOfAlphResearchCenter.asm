...
; example fossil lab script here
FossilScientist:
	faceplayer
	opentext
...
RuinsOfAlphResearchCenter_MapEvents:
	...
	object_event  0,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, FossilScientist, -1
