...
NationalParkGate_MapEvents:
	...
	warp_event  4,  7, NEW_BARK_TOWN, 4 ; placeholder
	warp_event  5,  7, NEW_BARK_TOWN, 4 ; placeholder
	...
	def_object_events
	object_event  0,  3, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route36OfficerScriptContest, EVENT_NATIONAL_PARK_GATE_OFFICER_CONTEST_DAY
	...
	object_event  3,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NationalParkGateOfficerScript, EVENT_NATIONAL_PARK_GATE_OFFICER_NOT_CONTEST_DAY
