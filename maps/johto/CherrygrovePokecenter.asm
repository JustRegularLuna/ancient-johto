; text constants
	const_def 1
	; NPCs
	const_export CHERRYGROVE_POKECENTER_NURSE
	const_export CHERRYGROVE_POKECENTER_LINK_RECEPTIONIST
	const_export CHERRYGROVE_POKECENTER_WONDER_TRADE_RECEPTIONIST
	const_export CHERRYGROVE_POKECENTER_BENCH_GUY
	const_export CHERRYGROVE_POKECENTER_GENTLEMAN
	; signs
