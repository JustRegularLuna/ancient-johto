; text constants
	...
	const_export KANSAI_ROUTE_1_BERRYTREE
...
KansaiRoute1_Object:
	...
	def_object_events
	object_event 26,  9, SPRITE_POKE_BALL, STAY, NONE, KANSAI_ROUTE_1_ITEMBALL, NUGGET
	object_event 13,  4, SPRITE_FRUIT_TREE, STAY, NONE, KANSAI_ROUTE_1_BERRYTREE
