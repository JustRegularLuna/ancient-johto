...
BenchCooltrainerSpriteGFX::    INCBIN "gfx/sprites/bench_cooltrainer.2bpp"
BenchGuySpriteGFX::            INCBIN "gfx/sprites/bench_guy.2bpp"
BenchLassSpriteGFX::           INCBIN "gfx/sprites/bench_lass.2bpp"
...
InnKeeperSpriteGFX::           INCBIN "gfx/sprites/inn_keeper.2bpp"
...
SilphGirlSpriteGFX::           INCBIN "gfx/sprites/silph_girl.2bpp"
SilphGuySpriteGFX::            INCBIN "gfx/sprites/silph_guy.2bpp"
SilphPresidentSpriteGFX::      INCBIN "gfx/sprites/silph_president.2bpp"
SurfingLaprasSpriteGFX::       INCBIN "gfx/sprites/surfing_lapras.2bpp"
