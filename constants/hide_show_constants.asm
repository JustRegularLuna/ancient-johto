...
; Johto flags
	...
	const HS_VIOLET_ITEMBALL_1
	const HS_VIOLET_ITEMBALL_2
	const HS_ROUTE_29_ITEMBALL
	const HS_ROUTE_30_YOUNGSTER_ALAN
	const HS_ROUTE_30_YOUNGSTER_ALAN_BLOCKER
	const HS_ROUTE_30_RATTATA_BLOCKER_1
	const HS_ROUTE_30_RATTATA_BLOCKER_2
	const HS_ROUTE_31_ITEMBALL_1
	const HS_ROUTE_31_ITEMBALL_2
	const HS_ROUTE36_SUDOWOODO
