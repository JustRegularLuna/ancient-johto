...
TextPredefs::
	add_tx_pre AerodactylFossilText
	add_tx_pre KabutopsFossilText
	...
	add_tx_pre GameCornerOutOfOrderText
	add_tx_pre GameCornerOutToLunchText
	add_tx_pre GameCornerSomeonesKeysText
	add_tx_pre FoundHiddenCoinsText
