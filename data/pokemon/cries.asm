...
; entries correspond to constants/pokemon_constants.asm
	table_width 6, PokemonCries
	mon_cry CRY_CHIKORITA,   -16,  176 ; CHIKORITA
	mon_cry CRY_CHIKORITA,   -34,  288 ; BAYLEEF
	mon_cry CRY_CHIKORITA,  -183,  512 ; MEGANIUM
	mon_cry CRY_TEDDIURSA,   839,  128 ; CUBBURN
	mon_cry CRY_TEDDIURSA,   801,  288 ; FLAMBEAR
	mon_cry CRY_TEDDIURSA,   700,  212 ; DYNABEAR
	mon_cry CRY_CLEFAIRY,   1132,  232 ; CRUZ
	mon_cry CRY_CLEFAIRY,   1088,  272 ; AQUA
	mon_cry CRY_CLEFAIRY,   1020,  384 ; AQUARIA
	...
	mon_cry CRY_LEDYBA,     -150,  312 ; TRIPSTAR
	mon_cry CRY_SPINARAK,     17,  512 ; SPIDETTE
	mon_cry CRY_SPINARAK,   -174,  482 ; DUARACH
	...
	mon_cry CRY_SENTRET,     138,  184 ; RINRING
	mon_cry CRY_SENTRET,     107,  258 ; BELLBOYANT
	mon_cry CRY_CLEFAIRY,     96,  100 ; MEOWSY
	mon_cry CRY_CLEFAIRY,    119,  144 ; MEOWTH
	mon_cry CRY_CLEFAIRY,    153,  383 ; PERSIAN
	mon_cry CRY_VULPIX,      204,  129 ; KOTORA
	mon_cry CRY_VULPIX,      170,  160 ; RAITORA
	...
	mon_cry CRY_MARILL,      299,  184 ; BLOSSETTE
	mon_cry CRY_SUNFLORA,    -32,  384 ; SUNNEE
	...
	mon_cry CRY_CLEFFA,       59,  200 ; PURRLEAF
	mon_cry CRY_CLEFFA,       39,  312 ; DANDEMEOW
	mon_cry CRY_CLEFFA,        0,  384 ; COTTONYA
	...
	mon_cry CRY_WEEPINBELL,   85,  129 ; BELLMITT
	...
	mon_cry CRY_CLEFFA,     -675,  456 ; POLIKING
	...
	mon_cry CRY_FEAROW,       60,  256 ; TURBANN
	...
	mon_cry CRY_SPEAROW,     386,  256 ; MADAME
	...
	mon_cry CRY_SEEL,       -675,  256 ; LICKIRAJA
	...
	mon_cry CRY_AMPHAROS,     53,  224 ; PLUX
	...
	mon_cry CRY_AIPOM,        44,  264 ; HITMONTYKE
	mon_cry CRY_GOLEM,       128,  320 ; HITMONLEE
	mon_cry CRY_SEEL,        238,  320 ; HITMONCHAN
	mon_cry CRY_SLUGMA,        0,  256 ; HITMONJEAN
	mon_cry CRY_AMPHAROS,   2217,  384 ; SKARMORY
	mon_cry CRY_AIPOM,      -352,  384 ; STANTLER
	mon_cry CRY_HOOTHOOT,    304,  232 ; MISDREAVUS
	mon_cry CRY_HOOTHOOT,    635,  324 ; TWINZ
	mon_cry CRY_GIRAFARIG,    65,  512 ; GIRAFARIG
	mon_cry CRY_DUNSPARCE,     0,  256 ; KURSTRAW
	mon_cry CRY_DUNSPARCE,    80,  256 ; PANGSHI
	mon_cry CRY_SEEL,          0,  512 ; BOMSEEL
	mon_cry CRY_WOOPER,       83,  175 ; KAMEASEL
	mon_cry CRY_TYPHLOSION,   40,  256 ; WOLFMAN
	mon_cry CRY_TYPHLOSION,    0,  512 ; WARWOLF
	...
	mon_cry CRY_MANTINE,    -190,  240 ; RAYLEEP
	mon_cry CRY_SLOWKING,    352,  224 ; QWILFISH
	mon_cry CRY_CYNDAQUIL,   720,  272 ; NUMPUFF
	mon_cry CRY_MAGCARGO,    161,  232 ; SUNMOLA
	mon_cry CRY_SLUGMA,      161,  232 ; ANCHORAGE
	mon_cry CRY_TOTODILE,    161,  232 ; GROTESS
	...
	mon_cry CRY_SENTRET,     162,  320 ; LEAFEON
	...
	mon_cry CRY_RAIKOU,      558,  288 ; RAIJIN
	mon_cry CRY_ENTEI,         0,  416 ; ENTEN
	mon_cry CRY_MAGCARGO,      0,  384 ; SUIKAMI
	mon_cry CRY_TYPHLOSION,    0,  256 ; LUGIA
	mon_cry CRY_AIPOM,         0,  384 ; HO_OH
	mon_cry CRY_PARAS,       153,  383 ; MEWTWO
	mon_cry CRY_PARAS,       238,  383 ; MEW
	mon_cry CRY_ENTEI,       330,  273 ; SEREBII
	mon_cry CRY_NIDORAN_M,     0,    0 ; MON_GHOST
