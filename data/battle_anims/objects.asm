...
; BATTLE_ANIM_OBJ_SAFARI_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_SMALL_ROCK, BATTLE_ANIM_FUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, $09
; BATTLE_ANIM_OBJ_SAFARI_BAIT
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_THROW_SAFARI, BATTLE_ANIM_FUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, $09
